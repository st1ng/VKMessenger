...
public class SaveUploadFilesTask extends BasicAsyncTask<ServerUploadFile, Void, String> {

	public SaveUploadFilesTask(AsyncCallback<String> callback) {
		super(callback);
	}
...
//			return null;
	...
	public String parseResponse(String response) throws JsonParseException {
		...
		return JSONParser.parseMessagesUploadFileId(response);
	}
